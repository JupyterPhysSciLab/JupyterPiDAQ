...
__Figure 4__: Image of the first tab in the four tab (4 step) Pandas New 
...
The GUI destroys itself once you complete step 4.
##### Fitting data
Currently there is no GUI tool to help you do this. Try the [lmfit python 
package](https://lmfit.github.io/lmfit-py/) for a reasonable command/text
based tool. It works nicely with the [Pandas](https://pandas.pydata.org/) data
structures used by JupyterPiDAQ.